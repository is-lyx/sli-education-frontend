<template>
  <div style="padding:30px;">
    ...
    >
      <el-row :gutter="32">
        <el-col :span="18">
          <p style="margin-left:50px;">{{ index+1 }}.【{{ item.type }}】 {{ item.question }}</p>
        </el-col>
        <el-col :span="6">
          <el-button type="info" @click="deleteQuestion(item.id)">取消关注</el-button>
...
export default {
  ...
  methods: {
    ...
    deleteQuestion(id) {
      this.$confirm('此操作将取消关注该题目, 是否继续?', '提示', {
