<template>
  <div style="padding: 30px">
    ...
    <el-card style="margin: 15px 15px">
      ...
      <h4 style="text-align: center; font-size: 18px">班级：{{ className }}</h4>
      <el-card
    ...
    getTestData() {
      const data = [
        ...
        },
        {
          id: '2',
          question:
            '把一个由木条钉成的长方形捏住对角，拉成一个平行四边形，那么这两个图形的（　　）',
          img: '',
          optionA: '面积相等，周长也相等',
        ...
        },
        {
          id: '3',
          question:
            '如图中，长方形的面积是12平方厘米，那么，阴影部分的面积是（　　）平方厘米．',
          img: '',
          optionA: '24',
          optionB: '12',
          optionC: '6',
        ...
        },
        {
          id: '4',
          question:
            '圆形滑冰场的一周全长是200米．沿着这一圈每隔10米安装一盏灯，一共要安（　　）盏灯．',
          img: '',
          optionA: '19',
          optionB: '20',
          optionC: '21',
